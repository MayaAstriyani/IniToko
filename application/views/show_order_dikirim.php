<?php $data = $this->model->getOrderDikirim(); ?>
<style type="text/css">
    body {
        color: #566787;
		background: #f5f5f5;
...
<div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4">
						<h2>Order <b>Sedang Dikirim</b></h2>
					</div>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
				...
				?>
                    <tr>
						...
						<td><a href="index.php?/Initoko/terkirimOrder/<?php echo $d['id_pesanan']; ?>" class="btn btn-primary">Terkirim</a></td>                        
					</tr>
				<?php } ?>
                </tbody>
            </table>
