<?php $data = $this->model->getOrderDibayar(); ?>
<style type="text/css">
    body {
        color: #566787;
		background: #f5f5f5;
            ...
            <table class="table table-striped table-hover">
				...
				?>
                    <tr>
						...
						<td><a href="index.php?/Initoko/konfirmasiOrder/<?php echo $d['id_pesanan']; ?>" class="btn btn-primary">Konfirmasi</a></td>                        
					</tr>
				<?php } ?>
                </tbody>
            </table>
