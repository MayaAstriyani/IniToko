<?php $data = $this->model->getOrderDikonfirmasi(); ?>
<style type="text/css">
    body {
        color: #566787;
		background: #f5f5f5;
            ...
            <table class="table table-striped table-hover">
				...
				?>
                    <tr>
						...
						<td><a href="index.php?/Admin/kirimBarang?id=<?php echo $d['id_pesanan']; ?>" class="btn btn-primary">Kirim</a></td>                        
					</tr>
				<?php } ?>
                </tbody>
            </table>
