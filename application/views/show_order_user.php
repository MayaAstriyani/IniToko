<?php 
    ...
    $data = $this->model->getOrderUser($id); 
?>
<style type="text/css">
    body {
        color: #566787;
...
<div class="container">
						...
						<td>
                            <?php
                                if ($d['status'] == "Belum Dibayar") {
                                    echo "<a href='index.php?/Initoko/show_detail_order_user?id=".$d['id_pesanan']."' class='btn btn-primary'>Lihat</a>";
                                }
                                else if ($d['status'] == "Dibayar") {
                                    echo "<a href='index.php?/Initoko/show_detail_order_user?id=".$d['id_pesanan']."' class='btn btn-primary'>Lihat</a>";
                                }
                                else if ($d['status'] == "Dikonfirmasi") {
                                    echo "<a href='index.php?/Initoko/show_detail_order_user?id=".$d['id_pesanan']."' class='btn btn-primary'>Lihat</a>";
                                }
                                else if ($d['status'] == "Sedang Dikirim") {
                                    echo "<a href='index.php?/Initoko/konfirmasiOrder/".$d['id_pesanan']."' class='btn btn-primary'>Lacak</a>";
                                }
        ...
        <a href="index.php?/Initoko/profile" id="kembali" class="btn btn-primary">Kembali</a>
    </div>
    </div>
    </div>
